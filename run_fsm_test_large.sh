#!/bin/bash -l
#SBATCH -o ./slurm_logs/fsm_test_large_%x_%A_%a.out
#SBATCH -e ./slurm_logs/fsm_test_large_%x_%A_%a.err
#SBATCH -D ./
...
#SBATCH --job-name=fsm_test_large
#SBATCH --array=0-29

# FSM REPRESENTATION EXPERIMENT - TESTING PHASE (LARGE NETWORKS, H=16)
# 30 tasks: 3 games x 10 seeds (mirrors run_fsm_train_large.sh)
...
TRAIN_DIR="experiments/fsm_train_large_946552"
TEST_OUTPUT_DIR="experiments/fsm_test_large_${SLURM_ARRAY_JOB_ID}"
...
echo "=========================================="
echo "FSM TESTING (LARGE H=16) - Task ${SLURM_ARRAY_TASK_ID}"
echo "=========================================="
