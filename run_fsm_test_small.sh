#!/bin/bash -l
#SBATCH -o ./slurm_logs/fsm_test_small_%x_%A_%a.out
#SBATCH -e ./slurm_logs/fsm_test_small_%x_%A_%a.err
#SBATCH -D ./
...
#SBATCH --job-name=fsm_test_small
#SBATCH --array=0-29

# FSM REPRESENTATION EXPERIMENT - TESTING PHASE (SMALL NETWORKS, H=4)
# 30 tasks: 3 games x 10 seeds (mirrors run_fsm_train_small.sh)
...
TRAIN_DIR="experiments/fsm_train_small_946468"
TEST_OUTPUT_DIR="experiments/fsm_test_small_${SLURM_ARRAY_JOB_ID}"
...
echo "=========================================="
echo "FSM TESTING (SMALL H=4) - Task ${SLURM_ARRAY_TASK_ID}"
echo "=========================================="
