...
#SBATCH --job-name=gen_matrix_test_s10_19_p3
#SBATCH --array=0-249%100

# TESTING PHASE - SEEDS 10-19 (Additional Run) - PART 3 of 3
# 250 tasks: Tasks 2000-2249 (out of 2250 total)
...
if [ -z "$TRAINING_JOB_ID" ]; then
    ...
    echo "Usage: TRAINING_JOB_ID=12345 sbatch run_generalization_matrix_test_seeds_10_19_part3.sh"
    exit 1
fi
...
# Decode array task ID (offset by 2000)
TASK_ID=$((SLURM_ARRAY_TASK_ID + 2000))
...
echo "=========================================="
echo "TESTING PHASE (SEEDS 10-19) PART 3 - Task ${TASK_ID}"
