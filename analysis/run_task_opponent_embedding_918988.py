"""
Task-Opponent Setup: Embedding Analysis (Metric 4) - Experiment 918988/918989

Analyzes which embeddings (social vs environmental) are used by agents
trained with reduced network architecture (128 hidden units, 2 layers).

Research Question: Do smaller networks show higher variability in embedding usage?
Do specialized agents learn to integrate opponent behavior?
"""
...
# Paths - UPDATED FOR 918988/918989
BASE_DIR = Path(__file__).parent.parent
TRAIN_DIR = BASE_DIR / 'experiments' / 'generalization_matrix_train_918988' / 'training'
OUTPUT_DIR = BASE_DIR / 'results' / 'task_opponent_918988_analysis' / 'embedding_analysis'
