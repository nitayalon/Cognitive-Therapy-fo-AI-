#!/bin/bash -l
#SBATCH -o ./slurm_logs/fsm_train_generalist_large_%x_%A_%a.out
#SBATCH -e ./slurm_logs/fsm_train_generalist_large_%x_%A_%a.err
#SBATCH -D ./
...
#SBATCH --job-name=fsm_train_generalist_large
#SBATCH --array=0-29

# FSM REPRESENTATION EXPERIMENT - GENERALIST TRAINING PHASE (LARGE NETWORKS, H=16)
...
ARRAY_OUTPUT_DIR="experiments/fsm_train_generalist_large_${SLURM_ARRAY_JOB_ID}"
mkdir -p "${ARRAY_OUTPUT_DIR}/task_${SLURM_ARRAY_TASK_ID}"

echo "=========================================="
echo "FSM GENERALIST TRAINING (LARGE H=16) - Task ${SLURM_ARRAY_TASK_ID}"
echo "=========================================="
echo "Game:            ${GAME}"
