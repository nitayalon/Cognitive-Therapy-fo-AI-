#!/bin/bash -l
#SBATCH -o ./slurm_logs/fsm_test_generalist_medium_%x_%A_%a.out
#SBATCH -e ./slurm_logs/fsm_test_generalist_medium_%x_%A_%a.err
#SBATCH -D ./
...
#SBATCH --job-name=fsm_test_generalist_medium
#SBATCH --array=0-29

# FSM REPRESENTATION EXPERIMENT - GENERALIST TESTING PHASE (MEDIUM NETWORKS, H=8)
# 30 tasks: 3 games x 10 seeds (mirrors run_fsm_train_generalist_medium.sh)
...
# run_fsm_train_generalist_medium.sh has completed)
TRAIN_DIR="experiments/fsm_train_generalist_medium_REPLACE_WITH_JOB_ID"
TEST_OUTPUT_DIR="experiments/fsm_test_generalist_medium_${SLURM_ARRAY_JOB_ID}"
...
echo "=========================================="
echo "FSM GENERALIST TESTING (MEDIUM H=8) - Task ${SLURM_ARRAY_TASK_ID}"
echo "=========================================="
