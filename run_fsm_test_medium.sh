#!/bin/bash -l
#SBATCH -o ./slurm_logs/fsm_test_medium_%x_%A_%a.out
#SBATCH -e ./slurm_logs/fsm_test_medium_%x_%A_%a.err
#SBATCH -D ./
...
#SBATCH --job-name=fsm_test_medium
#SBATCH --array=0-29

# FSM REPRESENTATION EXPERIMENT - TESTING PHASE (MEDIUM NETWORKS, H=8)
# 30 tasks: 3 games x 10 seeds (mirrors run_fsm_train_medium.sh)
...
TRAIN_DIR="experiments/fsm_train_medium_946522"
TEST_OUTPUT_DIR="experiments/fsm_test_medium_${SLURM_ARRAY_JOB_ID}"
...
echo "=========================================="
echo "FSM TESTING (MEDIUM H=8) - Task ${SLURM_ARRAY_TASK_ID}"
echo "=========================================="
