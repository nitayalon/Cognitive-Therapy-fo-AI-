#!/usr/bin/env python3
"""
Train on PD with opponents [0.1, 0.3], test on PD with opponents [0.7, 0.9].
"""
...
def test_pd_train_pd_test_new_opponents():
    setup_logging("INFO")
    print("=== TEST: PD train -> PD test (new opponents) ===")
    ...
    report_path = os.path.join(output_dir, 'pd_train_pd_test_new_opponents.json')
...
if __name__ == "__main__":
    test_pd_train_pd_test_new_opponents()
    print("✅ PD train -> PD test (new opponents) completed")
